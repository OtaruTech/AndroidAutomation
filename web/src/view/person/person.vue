          ...
          <div class="user-card">
            ...
            <div class="user-information">
              <ul>
                ...
                <el-tooltip class="item" effect="light" content="Honeywell苏州研发中心" placement="top">
                  <li>
                    <i class="el-icon-data-analysis" />Honeywell苏州研发中心
                  </li>
                </el-tooltip>
                <li>
                  <i class="el-icon-video-camera-solid" />中国·江苏·苏州
                </li>
                <el-tooltip class="item" effect="light" content="GoLang/JavaScript/Vue/Gorm" placement="top">
                  <li>
                    <i class="el-icon-medal-1" />Android C/C++/Golang
                  </li>
                </el-tooltip>
